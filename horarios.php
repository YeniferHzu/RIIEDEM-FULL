...
<div class="container">
	<form class="m-auto w-50 mt-2 mb-2 " method="POST" enctype="multipart/form-data" action="acciones/horarios_insertar.php">
		<div class="mb-2">

		<h1>Horarios</h1>
		<h5 align="center">Sube la información sobre tus horarios</h5>
...
<div class="table-responsive">
	<table class="table table-sm table-striped align-middle">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `horarios` WHERE `id_usuarios` = '$id_usuarios'") or die(mysqli_error());
			while($datos=mysqli_fetch_assoc($query)){
				$contador++;
					$id_horarios=$datos['id_horarios'];
					$nombre=$datos['nombre'];
				...
				?>
				<tr hidden class="del_file<?php echo $datos['id_horarios']?>">  </tr>
				...
				<td><a href="horarios_cargar.php?id_horarios=<?php echo $id_horarios; ?>" class="link-success">
				<?php echo $valor ;?><br>Ver</a></td>
				<td><a class='btn btn-primary' href="editar_horarios.php?id_horarios=<?php echo $id_horarios?>">Editar</a><a class='btn btn-danger' href="acciones/horarios_eliminar.php?id_horarios=<?php echo $id_horarios?>">Eliminar</a></td>
