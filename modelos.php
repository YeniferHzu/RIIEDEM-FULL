...
<div class="container">
	<form class="m-auto w-50 mt-2 mb-2 " method="POST" enctype="multipart/form-data" action="acciones/modelos_insertar.php">
		<div class="mb-2">

		<h1>Modelos</h1>
		<h5 align="center">Sube la información sobre tus modelos</h5>
...
<div class="table-responsive">
	<table class="table table-sm table-striped align-middle">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `modelos` WHERE `id_usuarios` = '$id_usuarios'") or die(mysqli_error());
			while($datos=mysqli_fetch_assoc($query)){
				$contador++;
					$id_modelos=$datos['id_modelos'];
					$nombre=$datos['nombre'];
				...
				?>
				<tr hidden class="del_file<?php echo $datos['id_modelos']?>">  </tr>
				...
				<td><a href="modelos_cargar.php?id_modelos=<?php echo $id_modelos; ?>" class="link-success">
				<?php echo $valor ;?><br>Ver</a></td>
				<td><a class='btn btn-primary' href="editar_modelos.php?id_modelos=<?php echo $id_modelos?>">Editar</a><a class='btn btn-danger' href="acciones/modelos_eliminar.php?id_modelos=<?php echo $id_modelos?>">Eliminar</a></td>
