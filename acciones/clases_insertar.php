...
$fecha=date('Y-m-d H:i:s');
	if(!file_exists("../files/"."Clases_".$id_usuarios)){
		mkdir("../files/"."Clases_".$id_usuarios);
	}
	
	if(move_uploaded_file($tmp_name, $location)){
		mysqli_query($conn, "INSERT INTO `clases` VALUES('', '$nombre', '$categoria', '$fecha', '$tipo', '$archivoBLOB', '$id_usuarios')") or die(mysqli_error());
