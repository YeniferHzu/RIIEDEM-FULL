...
<div class="container">
	<form class="m-auto w-50 mt-2 mb-2 " method="POST" enctype="multipart/form-data" action="acciones/estancias_insertar.php">
		<div class="mb-2">

		<h1>Estancias</h1>
		<h5 align="center">Sube la información sobre tus estancias</h5>
...
<div class="table-responsive">
	<table class="table table-sm table-striped align-middle">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `estancias` WHERE `id_usuarios` = '$id_usuarios'") or die(mysqli_error());
			while($datos=mysqli_fetch_assoc($query)){
				$contador++;
					$id_estancias=$datos['id_estancias'];
					$nombre=$datos['nombre'];
				...
				?>
				<tr hidden class="del_file<?php echo $datos['id_estancias']?>">  </tr>
				...
				<td><a href="estancias_cargar.php?id_estancias=<?php echo $id_estancias; ?>" class="link-success">
				<?php echo $valor ;?><br>Ver</a></td>
				<td><a class='btn btn-primary' href="editar_estancias.php?id_estancias=<?php echo $id_estancias?>">Editar</a><a class='btn btn-danger' href="acciones/estancias_eliminar.php?id_estancias=<?php echo $id_estancias?>">Eliminar</a></td>
