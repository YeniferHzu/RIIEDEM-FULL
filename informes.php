...
<div class="container">
	<form class="m-auto w-50 mt-2 mb-2 " method="POST" enctype="multipart/form-data" action="acciones/informes_insertar.php">
		<div class="mb-2">

		<h1>Informes</h1>
		<h5 align="center">Sube la información sobre tus informes</h5>
...
<div class="table-responsive">
	<table class="table table-sm table-striped align-middle">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `informes` WHERE `id_usuarios` = '$id_usuarios'") or die(mysqli_error());
			while($datos=mysqli_fetch_assoc($query)){
				$contador++;
					$id_informes=$datos['id_informes'];
					$nombre=$datos['nombre'];
				...
				?>
				<tr hidden class="del_file<?php echo $datos['id_informes']?>">  </tr>
				...
				<td><a href="informes_cargar.php?id_informes=<?php echo $id_informes; ?>" class="link-success">
				<?php echo $valor ;?><br>Ver</a></td>
				<td><a class='btn btn-primary' href="editar_informes.php?id_informes=<?php echo $id_informes?>">Editar</a><a class='btn btn-danger' href="acciones/informes_eliminar.php?id_informes=<?php echo $id_informes?>">Eliminar</a></td>
