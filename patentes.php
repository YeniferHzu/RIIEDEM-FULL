...
<div class="container">
	<form class="m-auto w-50 mt-2 mb-2 " method="POST" enctype="multipart/form-data" action="acciones/patentes_insertar.php">
		<div class="mb-2">

		<h1>Patentes</h1>
		<h5 align="center">Sube la información sobre tus patentes</h5>
...
<div class="table-responsive">
	<table class="table table-sm table-striped align-middle">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `patentes` WHERE `id_usuarios` = '$id_usuarios'") or die(mysqli_error());
			while($datos=mysqli_fetch_assoc($query)){
				$contador++;
					$id_patentes=$datos['id_patentes'];
					$nombre=$datos['nombre'];
				...
				?>
				<tr hidden class="del_file<?php echo $datos['id_patentes']?>">  </tr>
				...
				<td><a href="patentes_cargar.php?id_patentes=<?php echo $id_patentes; ?>" class="link-success">
				<?php echo $valor ;?><br>Ver</a></td>
				<td><a class='btn btn-primary' href="editar_patentes.php?id_patentes=<?php echo $id_patentes?>">Editar</a><a class='btn btn-danger' href="acciones/patentes_eliminar.php?id_patentes=<?php echo $id_patentes?>">Eliminar</a></td>
