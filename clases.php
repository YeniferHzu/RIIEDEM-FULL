...
<div class="container">
	<form class="m-auto w-50 mt-2 mb-2 " method="POST" enctype="multipart/form-data" action="acciones/clases_insertar.php">
		<div class="mb-2">

		<h1>Clases</h1>
		<h5 align="center">Sube la información sobre tus clases</h5>
...
<div class="table-responsive">
	<table class="table table-sm table-striped align-middle">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `clases` WHERE `id_usuarios` = '$id_usuarios'") or die(mysqli_error());
			while($datos=mysqli_fetch_assoc($query)){
				$contador++;
					$id_clases=$datos['id_clases'];
					$nombre=$datos['nombre'];
				...
				?>
				<tr hidden class="del_file<?php echo $datos['id_clases']?>">  </tr>
				...
				<td><a href="clases_cargar.php?id_clases=<?php echo $id_clases; ?>" class="link-success">
				<?php echo $valor ;?><br>Ver</a></td>
				<td><a class='btn btn-primary' href="editar_clases.php?id_clases=<?php echo $id_clases?>">Editar</a><a class='btn btn-danger' href="acciones/clases_eliminar.php?id_clases=<?php echo $id_clases?>">Eliminar</a></td>
