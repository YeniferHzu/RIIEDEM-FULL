...
<div class="container">
	<form class="m-auto w-50 mt-2 mb-2 " method="POST" enctype="multipart/form-data" action="acciones/libros_insertar.php">
		<div class="mb-2">

		<h1>Libros</h1>
		<h5 align="center">Sube la información sobre tus libros</h5>
...
<div class="table-responsive">
	<table class="table table-sm table-striped align-middle">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `libros` WHERE `id_usuarios` = '$id_usuarios'") or die(mysqli_error());
			while($datos=mysqli_fetch_assoc($query)){
				$contador++;
					$id_libros=$datos['id_libros'];
					$nombre=$datos['nombre'];
				...
				?>
				<tr hidden class="del_file<?php echo $datos['id_libros']?>">  </tr>
				...
				<td><a href="libros_cargar.php?id_libros=<?php echo $id_libros; ?>" class="link-success">
				<?php echo $valor ;?><br>Ver</a></td>
				<td><a class='btn btn-primary' href="editar_libros.php?id_libros=<?php echo $id_libros?>">Editar</a><a class='btn btn-danger' href="acciones/libros_eliminar.php?id_libros=<?php echo $id_libros?>">Eliminar</a></td>
