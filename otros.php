...
<div class="container">
	<form class="m-auto w-50 mt-2 mb-2 " method="POST" enctype="multipart/form-data" action="acciones/otros_insertar.php">
		<div class="mb-2">

		<h1>Mis Formatos</h1>
		<h5 align="center">Sube la información sobre tus archivos personales</h5>
...
<div class="table-responsive">
	<table class="table table-sm table-striped align-middle">
		...
		<?php
			...
			$query = mysqli_query($conn, "SELECT * FROM `otros` WHERE `id_usuarios` = '$id_usuarios'") or die(mysqli_error());
			while($datos=mysqli_fetch_assoc($query)){
				$contador++;
					$id_otros=$datos['id_otros'];
					$nombre=$datos['nombre'];
				...
				?>
				<tr hidden class="del_file<?php echo $datos['id_otros']?>">  </tr>
				...
				<td><a href="otros_cargar.php?id_otros=<?php echo $id_otros; ?>" class="link-success">
				<?php echo $valor ;?><br>Ver</a></td>
				<td><a class='btn btn-primary' href="editar_otros.php?id_otros=<?php echo $id_otros?>">Editar</a><a class='btn btn-danger' href="acciones/otros_eliminar.php?id_otros=<?php echo $id_otros?>">Eliminar</a></td>
